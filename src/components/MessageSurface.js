  ...
  const MessageSurface = () => {
    ...
    function sendMessage(event)
    {
        if ( event.keyCode === 13 )
        {
            ...
            // *** //
            com( `https://backend-on-point.onrender.com/message/send/${uid}/${fid}/${el.value}`, function(e){} );
            // *** //
    ...
    function loadFriendlist()
    {
        ...
        // *** //
        com(
          `https://backend-on-point.onrender.com/message/friendlist/${uid}`,
          function(json)
          {
            ...
            for( let e of json )
                document.getElementById('friend_' + e.id).addEventListener(
                    ...
                    () => {
                        ...
                        // *** //
                        com(
                            `https://backend-on-point.onrender.com/message/share/${e.uid}/${e.fid}`,
                            function(jout)
                            {
                                const mio = document.getElementById("messageio");
                                // *** //
        ...
        // *** //
        com(
            `https://backend-on-point.onrender.com/message/reminderoptions/${uid}`,
            function(json)
            {
              ...
              for( let e of json )
                document.getElementById('reminder_'+e.id).addEventListener(
                    ...
                    () => {
                        ...
                        const fid = sessionStorage.getItem("friend");
                        // *** //
                        com( `https://backend-on-point.onrender.com/message/notify/${uid}/${fid}/${e.id}`, function(e){} );
                        // *** //
        ...
        <Grid container columns={12}>
            <div class="message-friend-column-1">
                ...
                <input type="text" class="message-input" id = "myfriend" placeholder="Find friend" onKeyDown={(e) => {
                    ...
                    if ( e.keyCode == 13 )
                    {
                        com( `https://backend-on-point.onrender.com/message/connect/friend/${uid}/${fid.value}`, function(e){
                            fid.value = "";
                            loadFriendlist();
                        } );
                    }
